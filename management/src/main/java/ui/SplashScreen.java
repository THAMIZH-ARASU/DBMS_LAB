...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Rendering Interface...", 10);
                    doTask("Rendering Interface...", 20);
                    doTask("Rendering Interface...", 30);
                    ...
                    doTask("Connecting To Database ...", 80);
                    doTask("Connecting To Database ...", 90);
                    doTask("Connecting To Database ...", 100);
                    doTask("Done ...", 100);
                    dispose();
